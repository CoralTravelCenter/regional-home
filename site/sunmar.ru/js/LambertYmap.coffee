...
import placemark_home from 'data-url:/site/sunmar.ru/inline-assets/placemark-home.svg'
import placemark_available from 'data-url:/site/sunmar.ru/inline-assets/placemark-available.svg'
...
export class LambertYmap
    constructor: (options) ->
        ...
        @options = {
            ...
            homeRegionFill: '#9db1cf'
            availableDestinationFill: '#ffc9b7'
            options...
        }
